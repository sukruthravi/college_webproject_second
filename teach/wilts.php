            ...
            <section class="notice-section-book">
                ...
                <div class="row">
                    <div class="col-1-of-2">
                        ...
                        <p class="paragraph">Causes of Wilt Disease: Generally, plants/trees/shrubs get wilt in case of water stress. Permanent wilting is caused by fungi when it attacks plant’s water conduct system. Wilt disease affects the vascular system of plants. Mostly the symptoms of wilt are same as blights.
...
Symptoms of Wilt Disease: The affected plants with wilt may turn yellow and ultimately die.
                    ...
                    <ul class="paragraph">
                        <li>Select wilt disease-resistant varieties of plants or seeds.</li>
<li>Don’t plant again in the same place where wilt problems have occurred.</li>
<li>Crop rotation is advisable.</li>
<li>Try to eliminate flea beetles.</li>
<li>Cut off affected branches and plants and destroy them.</li>
<li>Don’t apply too much of nitrogen fertilizers.</li>
                    ...
                    <div class="col-1-of-2">
                        <div class="composition">
                            <img src="img/wilt.jpg" alt="Photo 1" class="composition_photo composition_photo--p1" style="height: 30rem;width: auto;">
